...
namespace IIS.АСУ_Склад
{
    ...
    [View("НакладнаяE", new string[] {
            ...
            "МатериальноОтветственноеЛицо.ФИО as \'ФИО\'"}, Hidden=new string[] {
            "Заказ.ПрезентационныйАтрибут",
            "Заказ.Номер",
            "Заказ.ДатаЗаполнения",
            "МатериальноОтветственноеЛицо.ФИО"})]
    ...
    [MasterViewDefineAttribute("НакладнаяE", "МатериальноОтветственноеЛицо", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "ФИО")]
    [View("НакладнаяL", new string[] {
            ...
            "ДатаЗаполнения as \'Дата заполнения\'",
            "Заказ.Статус as \'Статус\'",
            "МатериальноОтветственноеЛицо.ФИО as \'ФИО\'"})]
